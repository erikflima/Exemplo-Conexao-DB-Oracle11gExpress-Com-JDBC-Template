...
public class UsuarioRepository {
	...
	public ResultadoModel cadastrar(UsuarioModel usuario){
		...
		try {
			...
			jdbcTemplate.update( QuerysRepository.INSERIR_USUARIO, 
					             usuario.getLogin(),
					             usuario.getSenha(),
					             usuario.getAtivo()
					            );
	...
	public List<UsuarioModel> usuarios(){
		 ...
		 List listaDeUsuarios = jdbcTemplate.query( QuerysRepository.CONSULTAR_USUARIOS, 
	...
	public UsuarioModel usuario(int codigo){
		 ...
		 UsuarioModel usuario = jdbcTemplate.queryForObject( QuerysRepository.SELECIONAR_USUARIO, 
